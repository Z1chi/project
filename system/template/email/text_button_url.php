...
<table class="text_wrapper_2" style="margin-left: auto; margin-right: auto; max-width: 670px; padding: 0 20px; width: 100%;" width="100%">
	<td>
		<p class="link" style="color: #787878; padding-bottom: 20px;">
			<?=$TEXT_TIP?><br />
			<a href="<?=$BUTTON_URL?>" style="color: #787878"><?=$BUTTON_URL?></a>
		</p>
	</td>
</table>
