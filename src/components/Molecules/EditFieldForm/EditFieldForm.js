...
export const EditFieldForm = (
    {
        value, onSubmit, hasConfirmField, confirmOldValue = false, onChangeFieldValue, validator, id, placeholder, type = 'text', formValidator, renderNewValueField, buttonText
    }) => {
