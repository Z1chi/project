        ...
        <div className='flowCard'>
            ...
            <div className='flowCard__text'>
                ...
                <div className='flowCard__subtitle'>
                    ...
                    {
                        <FlowItem 
                            difference={getDifference({ currentMonthValue: currentMonth.amount, lastMonthValue: lastMonth.amount })} 
                            flow={getFlow({ currentMonthValue: currentMonth.amount, lastMonthValue: lastMonth.amount })}
                        />
                    }
                    </div>
                </div>
